...
class Order(models.Model):
    ...
    def calculate_totals(self):
        """Calcula subtotal, tax y total basado en los items"""
    ...
    def get_items_count(self):
        """Retorna el número total de items en el pedido"""
...
class OrderItem(models.Model):
    ...
    def get_total_price(self):
        """Calcula el precio total de este item (precio * cantidad)"""
        return self.price * self.quantity


class Cart(models.Model):
    """Carrito de compras temporal o persistente"""
    ...
    user = models.OneToOneField(
        ...
        null=True,
        blank=True,
        help_text='Usuario autenticado (null para carritos de invitados)'
    )
    session_key = models.CharField(
        'Clave de sesión',
        max_length=40,
        blank=True,
        help_text='Para carritos de usuarios no autenticados'
    )
    created_at = models.DateTimeField('Fecha de creación', auto_now_add=True)
    updated_at = models.DateTimeField('Última actualización', auto_now=True)
    ...
    def __str__(self):
        ...
        return f"Carrito de invitado ({self.session_key[:8]}...)"
    
    def get_total_items(self):
        """Retorna el número total de items (suma de cantidades)"""
        return sum(item.quantity for item in self.items.all())
    ...
    def get_tax(self):
        """Calcula el IVA (19%)"""
        return self.get_subtotal() * Decimal('0.19')
...
class CartItem(models.Model):
    ...
    def decrease_quantity(self, amount=1):
        """Decrementa la cantidad (elimina si llega a 0)"""
