...
# ============================================================================
# NOTA: Las vistas auth() y logout_view() han sido reemplazadas por allauth
# Ahora se usan: /accounts/login/, /accounts/signup/, /accounts/logout/
# Este código se mantiene comentado por compatibilidad
# ============================================================================
